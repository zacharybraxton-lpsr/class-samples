...
print("What would you like to call the file you put your haiku in to?")
haikuPoem = raw_input()
...
print("Congradulation! To see your haiku just type cat with a space along with your file name!")
